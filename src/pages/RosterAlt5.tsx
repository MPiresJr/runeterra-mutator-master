        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold text-white drop-shadow-2xl">
              Champion Roster - Alt 5
            </h1>
            <p className="text-gray-300 mt-2 text-lg">
              Center Level & Compact Layout
            </p>
          </div>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white px-4 py-2 rounded-full font-bold shadow-lg border border-amber-500/50">
                    <Zap className="w-4 h-4" />
                    <span>Level {champion.Champion_level}</span>
                  </div>
                </div>
              </CardHeader>

              <CardContent className="relative z-10 space-y-3 bg-gray-900/60">
                {/* Compact Stars */}
                ...
                {editingCard === champion.Champion_name ? (
                  ...
                  <p className="text-gray-300 text-xs text-center bg-gray-800/40 rounded p-1 border border-gray-600/30">
                    {cardDescriptions[champion.Champion_name] || "No description"}
                  </p>
                )}

                {/* Single Container with All Circular Buttons */}
