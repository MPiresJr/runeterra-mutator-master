        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold text-white drop-shadow-2xl">
              Champion Roster - Alt 4
            </h1>
            <p className="text-gray-300 mt-2 text-lg">
              Side Level Display Variant
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredChampions.map((champion, index) => (
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20 bg-gradient-to-r from-amber-600 to-orange-600 text-white px-3 py-1 rounded-full font-bold text-sm shadow-lg border border-amber-500/50">
                LV {champion.Champion_level}
              </div>
              ...
              <CardContent className="relative z-10 space-y-4 bg-gray-900/60">
                {/* Stars - Horizontal Layout */}
                <div className="flex items-center justify-center gap-1 bg-gray-800/50 rounded-lg p-2">
                ...
                <div className="bg-gray-800/40 rounded-lg p-4 border border-gray-600/30">
                  <div className="flex justify-center gap-4">
                    <Button 
                      size="sm" 
                      className="w-[75px] h-[75px] rounded-full bg-gradient-to-r from-slate-700 to-gray-700 hover:from-slate-600 hover:to-gray-600 text-white border-0 shadow-lg flex flex-col items-center justify-center p-0"
                    ...
                    <Button 
                      size="sm" 
                      className="w-[75px] h-[75px] rounded-full bg-gradient-to-r from-gray-700 to-slate-700 hover:from-gray-600 hover:to-slate-600 text-white border-0 shadow-lg flex flex-col items-center justify-center p-0"
                ...
                <div className="bg-gray-800/40 rounded-lg p-4 border border-gray-600/30">
                  <div className="flex justify-center gap-4">
                    <Button 
                      size="sm" 
                      className="w-[75px] h-[75px] rounded-full bg-gradient-to-r from-emerald-800 to-green-800 hover:from-emerald-700 hover:to-green-700 text-white border-0 shadow-lg flex flex-col items-center justify-center p-0"
                    ...
                    <Button 
                      size="sm" 
                      className="w-[75px] h-[75px] rounded-full bg-gradient-to-r from-amber-800 to-orange-800 hover:from-amber-700 hover:to-orange-700 text-white border-0 shadow-lg flex flex-col items-center justify-center p-0"
              ...
              {!champion.Unlocked && (
                <div className="absolute top-2 left-2 bg-red-800 text-white text-xs px-2 py-1 rounded-full border border-red-700 shadow-lg">
                  🔒 Locked
                </div>
              )}
            </Card>
