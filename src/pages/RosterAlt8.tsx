        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold text-white drop-shadow-2xl">
              Champion Roster - Alt 8
            </h1>
            <p className="text-gray-300 mt-2 text-lg">
              Bottom Level Bar & Stacked Layout
            </p>
          </div>
        </div>
            ...
            >
              ...
              <CardContent className="relative z-10 space-y-4 bg-gray-900/60">
                ...
                {editingCard === champion.Champion_name ? (
                  ...
                  <p className="text-gray-300 text-sm bg-gray-800/40 rounded p-2 border border-gray-600/30 min-h-[2.5rem]">
                    {cardDescriptions[champion.Champion_name] || "No description added"}
                  </p>
                )}

                {/* Vertical Stack of Circular Buttons */}
                <div className="bg-gray-800/40 rounded-lg p-4 border border-gray-600/30 space-y-3">
              ...
              {/* Bottom Level Bar */}
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-amber-600 to-orange-600 text-white text-center py-2 font-bold text-sm shadow-lg">
